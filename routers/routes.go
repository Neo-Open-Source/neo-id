...
func InitRoutes() {
	...
	web.Router("/api/user/age-consent", &controllers.UserController{}, "post:SetAgeConsent")
	web.Router("/api/telemetry/report", &controllers.UserController{}, "post:ReportTelemetry")
	...
	web.Router("/api/user/account/export", &controllers.UserController{}, "post:ExportAccountData")
	web.Router("/api/user/account/verify/passkey/options", &controllers.UserController{}, "post:BeginAccountActionPasskeyOptions")
	...
	web.Router("/api/admin/telemetry", &controllers.AdminController{}, "get:GetTelemetry")
	...
	web.Router("/widget/auth", &controllers.MainController{}, "get:Get")
	web.Router("/widget/sdk.js", &controllers.MainController{}, "get:WidgetSDK")
