...
- ✅ OAuth авторизация через Google и GitHub
- ✅ Единый профиль пользователя для всех сервисов
- ✅ Dashboard для управления аккаунтом
- ✅ Управление подключенными сервисами
- ✅ Админ панель для управления пользователями
- ✅ Бан система и модерация
- ✅ JWT токены для межсервисной авторизации
