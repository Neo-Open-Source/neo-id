      ...
      <div className="neo-id-legal-page" style={{ width: 'min(100%, 760px)', margin: '0 auto' }}>
        <div className="neo-id-legal-card" style={{ background: 'var(--neo-surface-2)', border: '1px solid var(--neo-border-subtle)', borderRadius: 24, padding: 32 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <Section title="5. Data Retention">We retain account information for as long as your account remains active. Session and security logs may be stored for a limited period. When you delete your account, we delete or anonymize personal data unless retention is required for security or legal purposes.</Section>
            <Section title="6. Your Choices and Rights">You can update your profile information, change your password, manage linked OAuth providers, and revoke access for connected applications (where available in the product).</Section>
