      ...
      <div className="neo-id-legal-page" style={{ width: 'min(100%, 760px)', margin: '0 auto' }}>
        <div className="neo-id-legal-card" style={{ background: 'var(--neo-surface-2)', border: '1px solid var(--neo-border-subtle)', borderRadius: 24, padding: 32 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <Section title="12. Privacy Policy">Any personal data collected and processed as part of the Service is handled in accordance with our <a href="/privacy" style={{ color: 'inherit', textDecoration: 'underline' }}>Privacy Policy</a>.</Section>
            ...
            <Section title="15. Contact">For questions about these Terms, contact Neo ID administration at <a href="mailto:fenixoffc@gmail.com" style={{ color: 'inherit', textDecoration: 'underline' }}>fenixoffc@gmail.com</a>.</Section>
            <hr style={{ border: 'none', borderTop: '1px solid var(--neo-border-subtle)', margin: 0 }} />
